...
import com.example.chat_backend.controller.rest.dto.request.AddContactRequest;
import org.springframework.data.domain.Pageable;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.RestController;

import com.example.chat_backend.controller.rest.IAccountResource;
...
public class AccountResource implements IAccountResource {
    ...
    @Override
    public ResponseEntity<Void> addContact(AddContactRequest request) {
        log.info("addContact: {}", request);
        accountService.addContact(request.contact(), request.status());
